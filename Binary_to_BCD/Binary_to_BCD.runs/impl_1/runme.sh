...
HD_PWD='D:/FPGA/FPGA_Binary_to_BCD/Binary_to_BCD/Binary_to_BCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bin2BCD_4dig.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bin2BCD_4dig.tcl -notrace
