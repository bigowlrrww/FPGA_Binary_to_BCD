...
HD_PWD='D:/FPGA/FPGA_Binary_to_BCD/Binary_to_BCD/Binary_to_BCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bin2BCD_4dig.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bin2BCD_4dig.tcl
